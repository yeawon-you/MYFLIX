    ...
    <div class="review_form">
       <!--파일첨부를 위한 ENCTYPE추가-->
          ...
          <div class="movie_title_input">  
            <input type="text" name="MOVIETITLE" placeholder="작품 제목을 입력하세요" size="83">    
          </div>
          <!--// movie_title-->
          ...
          <div class="review_title_input">
            <input type="text" name="TITLE" placeholder="리뷰 제목을 입력하세요" size="83"> 
           </div>
          <!-- // review_title-->
          ...
          <textarea class="textarea1" name="CONTENT" cols="300" rows="50" placeholder="리뷰를 입력해주세요"></textarea>
          </div>
