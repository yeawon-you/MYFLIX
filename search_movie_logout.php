    ...
    <div class="result_form">
      ...
      <div class="other_movies_out">
         ...
         <div class="other_movies_in">
            ...
            <form name="search_relate_movie" method="get" action="search_movie3_logout.php">
            <input type="image" name="FILE" src="<?php echo $POSTER; ?>" width="290" height="170" value="<?php echo $TITLE;?>" onclick="mysub(2)">
...
<script>
  ...
  function mysub(index){
    ...
    if(index==2){                                 
      document.search_relate_movie.action="search_movie3_logout.php";
