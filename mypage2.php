...
<!--헤드시작 : my page-->
      <div class="my_head">
         <p style="text-align: center;">
            <img src="https://github.com/yeawon-you/MYFLIX/blob/master/images/mypage.png?raw=true">
         </p>
      </div>
<!--헤드끝-->
...
<!--my form 시작-->
	...
	<!--프로필 닉네임-->
         <div class="my_title">
            <a href="change_info.php"><p style="font-size: 20px;"><b><?php echo $_SESSION['NICKNAME'];?></b><!--<?php?>--></p></a>
         </div>
	...
	<!--내가 쓴 글 : 이미지 글-->
	 ...
	 <div class="my_work_head">
            <img src="https://github.com/yeawon-you/MYFLIX/blob/master/images/%EB%82%B4%EA%B0%80%20%EC%93%B4%20%EA%B8%80.png?raw=true"/>
         </div>
...
<?php
   		...
   		$sql = "SELECT * FROM Comment WHERE ID = '$ME' ORDER BY COUNT DESC";
  ...
  <div class="my_feed_article">
      ...
      <div class="my_feed_profile">
            ...
            <div class="my_profile_name">
             <span style="display: table-cell;"><b><?php echo $_SESSION['NICKNAME'];?></b></span>
             </div>
...
<!--프로필 (사진, 닉네임) 끝 -->
      ...
      <div class="my_feed_comment">
         <p><b><?php echo $_SESSION['NICKNAME'];?></b> <?php echo $CONTENTS; ?></p>
         <br>
