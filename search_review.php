...
$row=mysqli_fetch_assoc($result); //위 결과 값을 하나하나 배열로 저장합니다 .
$total_no=$row['COUNT']; //배열의 첫번째 요소의 값, 즉 테이블의 전체 글 수를 저장합니다.
...
$query="select * from $tablename WHERE $category LIKE '%$search_term%'"; // SQL 쿼리문
...
<form name="searchreview" action="search_review.php" method="post">
